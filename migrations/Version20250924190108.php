 ...
 */
final class Version20250924190108 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE teams (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_96C222586C6E55B5 (nom), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL, identifiant VARCHAR(180) NOT NULL, nom VARCHAR(100) NOT NULL, prenom VARCHAR(100) NOT NULL, mail_pro VARCHAR(180) DEFAULT NULL, mail_perso VARCHAR(180) DEFAULT NULL, mot_de_passe VARCHAR(255) NOT NULL, telephone VARCHAR(10) DEFAULT NULL, fonction VARCHAR(50) DEFAULT NULL, metier VARCHAR(50) DEFAULT NULL, bureau VARCHAR(50) DEFAULT NULL, roles JSON NOT NULL, derniere_connexion DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_1483A5E9C90409EC (identifiant), UNIQUE INDEX UNIQ_1483A5E977AFF995 (mail_pro), UNIQUE INDEX UNIQ_1483A5E989A1584E (mail_perso), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
